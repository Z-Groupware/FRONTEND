...
export const ENV_ENTRIES: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "회의 자막을 쓰려면 필요해요. 브라우저가 물어보면 허용해 주세요.\n\n거부하셨거나 지원하지 않는 브라우저라면 화면에서 알려 드립니다 — 조용히 안 되는 채로 두지 않아요.",
  },
  {
    id: "account-manage",
    category: FAQ_CATEGORY.ENV,
    ...
    answer:
      "회사가 관리해요. 계정은 회사 관리자가 발급하고, 한 계정은 하나의 회사에 속합니다.\n\n개인이 직접 가입하거나 탈퇴하는 구조가 아니에요.",
