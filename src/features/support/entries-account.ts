...
export const ACCOUNT_ENTRIES: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    keywords: ["부서", "직급", "조직", "체계", "구조", "계층", "역할", "리더"],
    answer:
      "부서 아래에 역할이 오는 2계층입니다. 역할은 비워 둘 수도 있습니다.\n\n사원은 부서에 소속되고, 권한은 부서가 아니라 직급에서 옵니다.\n\nLeader 직급은 회사에 하나이고, 그 직급을 가진 사람은 부서마다 한 명입니다. 그 사람의 역할은 ‘리더’로 자동으로 정해집니다 — 따로 고르지 않습니다.\n\n역할이 하나도 없는 부서라면 나머지 사원의 역할은 ‘없음’이 됩니다.",
    links: [{ label: "권한 매트릭스 보기", href: "/roles" }],
  },
  {
    id: "meeting-owner",
