...
export const ACCOUNT_ENTRIES: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "로그인 화면의 ***[비밀번호를 잊으셨나요?]***에서 기업 코드와 이메일을 입력하면 새 비밀번호를 메일로 받을 수 있습니다.\n\n계정당 하루 3회까지 가능합니다.",
  },
  {
    id: "invite",
    category: FAQ_CATEGORY.ACCOUNT,
  ...
  },
  {
    ...
    answer:
      "- **Owner** — 기업 전체 관리\n- **Leader** — 팀 현황·액션 관리\n- **Member** — 일반 사용\n\n여기에 **+Admin**(겸직) — 회의실·직급 권한 관리가 얹힙니다. 계정 발급은 대표(Owner)도 Admin도 할 수 있습니다. 회의 개설이나 액션 조회 같은 건 Admin을 켠다고 늘지 않고, ***그 사람의 권한이 정합니다.***\n\n표로 정리한 화면이 따로 있습니다.",
    links: [{ label: "권한 매트릭스 보기", href: "/roles" }],
  },
  {
    id: "leader-scope",
  ...
  },
  {
    ...
    */
    answer:
      "사원은 **재직 · 휴직 · 대기 · 퇴사**로 나뉩니다.\n\n***대기는 승인 대기입니다*** — 휴직이나 오프보딩을 신청하고 결재를 기다리는 상태입니다. 승인되면 휴직 또는 퇴사로 바뀝니다.\n\n***퇴사한 사람도 목록에는 남습니다.*** 그 사람이 남긴 회의·액션·인수인계 기록을 계속 따라갈 수 있어야 하기 때문입니다.",
  },
  {
    id: "handover-flow",
    category: FAQ_CATEGORY.ACCOUNT,
