...
export const PRODUCT_ENTRIES: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    // ⚠️ 없는 걸 있는 것처럼 흘리지 않는다 — 먼저 "없다"고 말하고 대안을 준다(§정직성)
    answer:
      "***무료 요금제는 없습니다.*** 결제하셔야 워크스페이스가 열립니다.\n\n대신 등급을 나눠 놓고 위 등급을 파는 방식이 아니라, **기능은 처음부터 전부 열려 있습니다.**\n\n인원도 제한이 없습니다 — 몇 명을 초대해도 기본료는 같습니다.",
    links: [{ label: "요금제 보기", href: "/plans" }],
  },
  {
    id: "plan-change",
