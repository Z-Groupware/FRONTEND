...
export const PRODUCT_ENTRIES: readonly FaqEntry[] = [
  ...
  },
  {
    ...
    answer: "네, 통합 검색이 있습니다. 회의·자막·액션을 한 곳에서 찾습니다.",
  },
  {
    id: "handover",
    category: FAQ_CATEGORY.SERVICE,
  ...
  },
  {
    ...
    answer:
      "대기 · 진행중 · 완료 세 가지입니다.\n\n마감이 지났는데 완료가 아니면 지연으로 표시되는데, 이건 따로 두는 상태가 아니라 날짜로 계산되는 값입니다.",
  },
  {
    id: "action-split",
    category: FAQ_CATEGORY.SERVICE,
  ...
  },
  {
    ...
    answer:
      "회의는 예정 · 진행중 · 완료로 나뉘고, 초대받은 사람은 참석 · 불참 · 미응답으로 표시됩니다.",
  },
  {
    id: "board",
    category: FAQ_CATEGORY.SERVICE,
