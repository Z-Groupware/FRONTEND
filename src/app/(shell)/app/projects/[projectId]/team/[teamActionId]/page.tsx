      ...
      content: (
        <>
          <div className="flex items-center gap-1.5">
            ...
            <span
              className="shrink-0 rounded px-1.5 py-px font-mono text-[10px] leading-none font-semibold"
      ...
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-4">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className="rounded px-1.5 py-px font-mono text-xs leading-none font-semibold"
              style={{ backgroundColor: tagColor.bgColor, color: tagColor.textColor }}
            >
              {teamAction.projectTag}
            </span>
            <span className="bg-muted text-muted-foreground rounded px-1.5 py-px text-xs leading-none font-semibold">
              {teamAction.team}
            </span>
          </div>
        </div>
